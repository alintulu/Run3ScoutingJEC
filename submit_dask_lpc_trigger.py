...
from coffea.nanoevents import NanoEventsFactory, NanoAODSchema, ScoutingNanoAODSchema, ScoutingJMENanoAODSchema

import json

sample = sys.argv[1] #"Run2022D"
era = sys.argv[2] #"Run3Summer22"
isScouting="Scouting" in sample

trigger_processor = TriggerProcessor(isScouting=isScouting)
...
output = processor.run_uproot_job(
            ...
            executor_args={
                "schema": ScoutingJMENanoAODSchema if isScouting else NanoAODSchema,
